...
public record NotionConfigUpdateRequest(
    ...
    public NotionConfigUpdateServiceRequest toServiceRequest(Long companyId) {
        return NotionConfigUpdateServiceRequest.builder()
                .companyId(companyId)
                .token(token)
